...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> searchItemsForRental(Long id, String text) {
        Map<String, Object> parameters = Map.of("text", text);
        return get("/search?text={text}", id, parameters);
    }

    public ResponseEntity<Object> addComment(Long id, Long itemId, CommentText commentText) {
        return post("/" + itemId + "/comment", id, commentText);
    }
}
